public class Gambler extends Monster {
    ...
    */
    public Gambler() {
        super(100, 30, 0, 10, 1);
        about = "An addicted gambler who has faith in his luck. He bets on a coin every turn, and the player or himself get damaged whether he is right or wrong, respectively.";
    }
